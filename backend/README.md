...
## Project Structure
    ...
    ├── testapiautosetting_128794  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_128794`
...
2. Clone this repo and `cd testapiautosetting_128794`
